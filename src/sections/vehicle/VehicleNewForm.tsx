...
export default function VehicleEditForm({ isEdit = false, vehicle }: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
      registerNo: 'KA01MH4868',
      registrationType: RegistrationType.YELLOW_BOARD,
      bodySegment: BodySegment.SEDAN,
      permitType: PermitType.ALL_INDIA,
      permitNo: '1GV04EC015',
      make: Maker.FORD,
      model: 'FIESTA',
      year: '2012',
