...
const TABLE_HEAD = [
  { id: '', label: 'Model Name', align: 'left' },
  { id: '', label: 'Model Code', align: 'left' },
  
];

// ----------------------------------------------------------------------

VehicleModelsSection.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
  ...
  return (
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading="Vehicle Models Details"
