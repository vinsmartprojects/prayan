...
import UserBasicInfo from 'src/sections/user/details/UserBasicInfo';
import UserDrivers from 'src/sections/user/details/UserDrivers';
import UserTrips from 'src/sections/user/details/UserTrips';
import UserVechicles from 'src/sections/user/details/UserVechicles';


import { _userPayment, _userAddressBook, _userInvoices, _userAbout } from 'src/_mock/arrays';

UserDetailPage.getLayout = (page: React.ReactElement) => (
  ...
  const TABS = [
    {
      ...
      component: <UserBasicInfo id={id} />,
    },
    {
      value: 'trips',
      label: 'Trips',
      icon: <Iconify icon="bx:trip" />,
      component: <UserTrips id={id} />,
    },
    {
      value: 'vehicles',
      label: 'Vehicles',
      icon: <Iconify icon="ic:baseline-directions-car" />,
      component: <UserVechicles id={id} />,
    },
    {
      value: 'drivers',
      label: 'Drivers',
  ...
  return (<>
    ...
    <Container maxWidth={themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading={"User ID : " + id}
        links={[
          { name: 'Users', href: PATH_USER.root },
