...
const TABLE_HEAD = [
  { id: '', label: 'Segment Name', align: 'left' },
  { id: '', label: 'Segment Code', align: 'left' },
  
];

// ----------------------------------------------------------------------

VehicleSegmentSection.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;

// ----------------------------------------------------------------------

export default function VehicleSegmentSection() {
  const {
    dense,
    page,
    order,
  ...
  return (
    <>
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          heading="Vehicle Segment Details"
