...
import SettingBasicInfo from 'src/sections/setting/details/SettingBasicInfo';
import SettingDrivers from 'src/sections/setting/details/SettingDrivers';
import SettingTrips from 'src/sections/setting/details/SettingTrips';
import SettingVechicles from 'src/sections/setting/details/SettingVechicles';


import { _userPayment, _userAddressBook, _userInvoices, _userAbout } from 'src/_mock/arrays';

SettingDetailPage.getLayout = (page: React.ReactElement) => (
...
export default function SettingDetailPage() {
  ...
  const TABS = [
    {
      ...
      component: <SettingBasicInfo id={id} />,
    },
    {
      value: 'trips',
      label: 'Trips',
      icon: <Iconify icon="bx:trip" />,
      component: <SettingTrips id={id} />,
    },
    {
      value: 'vehicles',
      label: 'Vehicles',
      icon: <Iconify icon="ic:baseline-directions-car" />,
      component: <SettingVechicles id={id} />,
    },
    {
      value: 'drivers',
      label: 'Drivers',
  ...
  return (<>
    ...
    <Container maxWidth={themeStretch ? false : 'lg'}>
      <CustomBreadcrumbs
        heading={"Setting ID : " + id}
        links={[
          { name: 'Settings', href: PATH_SETTING.root },
