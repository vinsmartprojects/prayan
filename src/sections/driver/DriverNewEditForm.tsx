...
import { IDriverCreateInput } from 'src/@types/driver';
// ----------------------------------------------------------------------
...
export default function DriverNewEditForm({ isEdit = false, currentDriver }: Props) {
    ...
    const defaultValues = useMemo(
        () => ({
            ...
            primaryContactPerson: currentDriver?.primaryContactPerson || '',
                        ...
                        <RHFSwitch
                            ...
                            label={
                                <>
                                    ...
                                    <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                                        Disabling this will automatically send the Driver a verification email
                                    </Typography>
                                </>
                            }
