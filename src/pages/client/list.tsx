...
import { buildClientWhereFilter } from 'src/modules/client/helpers/buildWhereFilter';
...
export default function clientListPage() {
  ...
  const { getManyWithFilters, remove: deleteClient } = useClient();
  ...
  const [searchParam, setsearchParam] = useState<any | undefined>(ClientSearchParams.TITLE)
  const [searchQ, setsearchQ] = useState("")
  const { enqueueSnackbar } = useSnackbar();


  async function getClients(filter: any, reload?: any) {
