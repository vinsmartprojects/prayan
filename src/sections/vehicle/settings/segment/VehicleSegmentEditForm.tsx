...
export default function VehicleSegmentEditForm({ isEdit = false, vehicle }: Props) {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      segment: vehicle?.make || '',
      code: vehicle?.rcNo || undefined,
      ...
      <Grid container spacing={3}>
        <Grid item xs={12} md={8}>
          <Card sx={{ p: 3, m: 2 }}>
            ...
            >
              <RHFTextField name="make" label="Segment *" />
              <RHFTextField name="rcNo" label="code *" />
